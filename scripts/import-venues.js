...
const venues = [
  ...
  },
  {
    ...
    description: 'Niché à Haute-Goulaine, le Le Manoir de la Boulaie marie l\'élégance d\'une demeure de caractère à la douceur d\'un cadre naturel. Entouré de vignes et niché dans un jardin à l\'anglaise, ce lieu d\'exception accueille vos mariages et réceptions dans une atmosphère à la fois intime, conviviale et poétique. Chaque événement y devient une célébration sur mesure, portée par la beauté des lieux et le savoir-faire de nos équipes.',
