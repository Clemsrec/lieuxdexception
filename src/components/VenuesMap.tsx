...
export default function VenuesMap({ venues }: VenuesMapProps) {
 ...
 if (venuesWithCoords.length === 0) {
  return (
   <div className="w-full h-[600px] bg-stone-light flex items-center justify-center">
 ...
 return (
  <div className="w-full h-[600px] overflow-hidden shadow-lg border-2 border-accent/20">
   <MapContainer
    key="venues-map"
      ...
      >
       <div className="p-3">
        ...
        <Link
         ...
         className="block w-full text-center bg-accent hover:bg-accent-dark text-white! font-heading font-semibold py-3 px-4 transition-all duration-300 hover:shadow-lg"
        >
         Découvrir le lieu →
        </Link>
       </div>
