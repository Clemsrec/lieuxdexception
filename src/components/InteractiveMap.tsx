  ...
  return (
   <div className="space-y-4">
    {venues.map((venue) => (
     <div
      key={venue.id}
      className="bg-white shadow p-4 flex gap-4 hover:shadow-md transition"
     >
      <img
  ...
  return (
   <div className="bg-yellow-50 border border-yellow-200 p-6 text-center">
    ...
    <p className="text-sm text-yellow-700">
     Ajoutez <code className="bg-yellow-100 px-2 py-1">NEXT_PUBLIC_GOOGLE_MAPS_KEY</code> dans votre fichier <code className="bg-yellow-100 px-2 py-1 ">.env.local</code>
    </p>
   </div>
  );
 }
