...
export function FeatureCard({ number, title, content, className = '' }: FeatureCardProps) {
 return (
  <div className={`h-full p-8 bg-charcoal-800 shadow-lg hover:shadow-2xl transition-all duration-500 border border-accent/20 flex flex-col text-center group ${className}`}>
...
export function ContentBlock({
 ...
 return (
  <div className={`bg-stone-50 border border-stone/20 p-6 shadow-lg ${className}`}>
   {subtitle && (
 ...
 return (
  <section className={`section relative overflow-hidden ${className}`}>
   ...
   <div className="container relative z-10">
    <div className="text-center p-6 md:p-12 backdrop-blur-sm bg-black/30 border border-white/20">
