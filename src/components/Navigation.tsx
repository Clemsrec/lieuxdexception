  ...
  <nav className="absolute top-0 left-0 right-0 z-50 bg-transparent">
   <div className="container-wide">
    <div className="flex items-center justify-between min-h-20 md:h-24 lg:h-28 pt-6 pb-4 md:py-4">
      ...
      >
       ...
       {isVenuesOpen && (
        <div className="absolute top-full left-0 pt-1 z-50">
         <div className="w-64 bg-white shadow-xl border border-stone-200 py-2">
          <Link
     ...
     <button
      onClick={toggleMenu}
      className="md:hidden p-3 text-white hover:bg-white/10 transition-colors min-w-12 min-h-12 flex items-center justify-center"
