 ...
 return (
  <div className="fixed inset-x-0 bottom-0 z-50 pb-4 px-4 sm:px-6 lg:px-8">
   <div className="max-w-content mx-auto">
    <div className="bg-white border-2 border-primary/20 shadow-2xl p-6">
     {!showSettings ? (
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
       ...
       <div className="flex flex-col sm:flex-row gap-3 lg:shrink-0">
        <button
         ...
         className="px-4 py-2.5 text-sm font-medium text-foreground bg-muted hover:bg-muted/80 transition-colors"
        >
         Personnaliser
        </button>
        <button
        ...
        <button
         ...
         className="px-6 py-2.5 text-sm font-medium text-white bg-primary hover:bg-primary/90 transition-colors shadow-md"
        >
         Accepter tout
        </button>
       </div>
      ...
      <div>
        ...
        <div className="flex items-start justify-between p-4 bg-muted">
         ...
         <div className="flex items-center">
          <input
           ...
           checked={true}
           disabled
           className="w-5 h-5 border-2 border-primary/30 bg-primary/10 cursor-not-allowed"
          />
         </div>
        </div>
        ...
        <div className="flex items-start justify-between p-4 bg-muted">
         ...
         <div className="flex items-center">
          <input
           ...
           className="w-5 h-5 border-2 border-gray-300 checked:bg-primary checked:border-primary cursor-pointer"
          />
         </div>
        </div>
       ...
       <div className="flex flex-col sm:flex-row gap-3 justify-end">
        <button
         onClick={handleRejectAll}
         className="px-6 py-2.5 text-sm font-medium text-foreground bg-muted hover:bg-muted/80 transition-colors"
        >
         Refuser tout
        </button>
        <button
