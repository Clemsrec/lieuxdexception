 ...
 return (
  ...
  >
   <Link
    ...
    className="venue-card group overflow-hidden h-full flex flex-col bg-white shadow-lg hover:shadow-2xl transition-all duration-500 border border-stone/10"
   >
    ...
    <div className="p-6 md:p-8 flex-1 flex flex-col text-center bg-linear-to-b from-white to-stone-50/30">
     ...
     <div className="grid grid-cols-3 gap-3 mb-6">
      {/* Distance de Paris */}
      <div className="flex flex-col items-center gap-2 p-3 bg-stone-50/50 border border-stone/10 hover:border-accent/30 transition-colors">
     ...
     <div className="flex justify-center gap-4 mt-auto pt-6 border-t border-accent/10">
      <div className="px-4 py-2 bg-accent/5 border border-accent/20 text-xs font-semibold tracking-widest text-accent hover:bg-accent hover:text-white transition-all duration-300 cursor-pointer">
       PRIVÉ
      </div>
      <div className="px-4 py-2 bg-accent/5 border border-accent/20 text-xs font-semibold tracking-widest text-accent hover:bg-accent hover:text-white transition-all duration-300 cursor-pointer">
       PRO
  ...
  <>
        ...
        {venues
         ...
         .map((venue, index) => {
          ...
          return (
           <div
            key={venue.id}
            className="group flex flex-col overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 bg-neutral-800"
           >
            {/* Image */}
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
       {(pageContent?.featureCards?.filter(c => c.visible !== false).sort((a, b) => (a.order || 0) - (b.order || 0)) || [
        ...
        <div 
         ...
         className="h-full p-8 bg-charcoal-800 shadow-lg hover:shadow-2xl transition-all duration-500 border border-accent/20 flex flex-col text-center group"
        >
          {/* Numéro dans un cercle doré */}
          <div className="mb-6">
           <div className="inline-flex items-center justify-center w-16 h-16 bg-linear-to-br from-accent to-accent-dark text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
         ...
         <div className="mt-6 pt-6 border-t border-accent/20">
          <div className="w-2 h-2 bg-accent/60 mx-auto" />
         </div>
        </div>
       ))}
     </div>
   ...
   <section className="section bg-alt mt-0">
    <div className="container">
     ...
     <div className="overflow-hidden shadow-2xl border border-accent/20">
