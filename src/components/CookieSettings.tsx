  ...
  return (
    <div className="bg-white rounded-lg border-2 border-primary/20 p-6">
      ...
      <div className="space-y-4 mb-6">
        {/* Cookies essentiels */}
        <div className="flex items-start justify-between p-4 bg-muted rounded-lg border-2 border-green-200">
          ...
          <div className="flex items-center">
            <input
              ...
              checked={true}
              disabled
              className="w-5 h-5 rounded border-2 border-green-300 bg-green-100 cursor-not-allowed"
            />
          </div>
        </div>

        {/* Cookies analytiques */}
        <div className="flex items-start justify-between p-4 bg-muted rounded-lg border-2 border-gray-200">
          <div className="flex-1 pr-4">
          ...
          <div className="flex items-center">
            <input
              ...
              className="w-5 h-5 rounded border-2 border-gray-300 checked:bg-primary checked:border-primary cursor-pointer transition-colors"
            />
          </div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          onClick={handleSave}
          className="px-6 py-3 text-sm font-medium text-white bg-primary hover:bg-primary/90 rounded-lg transition-colors shadow-md"
        >
          Enregistrer mes préférences
        </button>
        <button
          onClick={handleReset}
          className="px-6 py-3 text-sm font-medium text-foreground bg-muted hover:bg-muted/80 rounded-lg transition-colors"
        >
          Réinitialiser
        </button>
      </div>
