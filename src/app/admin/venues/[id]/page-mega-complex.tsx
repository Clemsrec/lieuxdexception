...
import { ArrowLeft, Save, Loader2, FileText, MapPin, Users, Image as ImageIcon, Tag, Award } from 'lucide-react';
...
type TabId = 'general' | 'location' | 'capacity' | 'media' | 'amenities' | 'wedding';
