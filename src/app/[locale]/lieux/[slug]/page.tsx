      ...
      <div>
       <div className="flex items-center gap-4 mb-4 text-white/90">
        ...
        {venue.displayStatus === 'Nouveau' && (
         <span className="inline-flex items-center gap-2 px-4 py-2 bg-accent text-white text-sm font-medium">
          ★ Nouveau
         </span>
        )}
        {venue.displayStatus === 'Ouverture prochainement' && (
         <span className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white text-sm font-medium">
          Bientôt disponible
         </span>
        )}
       </div>
     ...
     <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
      ...
      <div className="lg:col-span-2 space-y-8">
       ...
       {venue.experienceText && (
        <div className="bg-charcoal-800 border border-accent/20 p-8">
     ...
     <div className="container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
       {venue.detailedSpaces.map((space, index) => (
        <div key={index} className="bg-charcoal-800 border border-accent/20 p-6 hover:border-accent transition-colors">
     ...
     <div className="container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
       {venue.activities.map((activity, i) => (
        <div key={i} className="bg-white p-6 border border-neutral-200 hover:shadow-lg transition-shadow">
    ...
    <div className="container">
     <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
       ...
       {/* CTA */}
       <div className="bg-charcoal-800 text-white p-8 border border-accent/20">
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {venues
       ...
       .map((otherVenue) => (
        <div
         key={otherVenue.id}
         className="group flex flex-col overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 bg-neutral-700"
        >
         {/* Image */}
