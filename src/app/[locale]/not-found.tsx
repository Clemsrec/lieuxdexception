  ...
  <div className="min-h-screen w-full relative overflow-hidden bg-neutral-50">
   ...
   <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
    <div className="w-full">
     ...
     {/* Carte principale */}
     <div
      className={`bg-white/95 backdrop-blur-sm shadow-2xl p-6 sm:p-8 md:p-12 border border-white/50 transition-all duration-700 delay-200 max-w-content mx-auto ${
       mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
      }`}
     >
      {/* 404 animé */}
      ...
      {/* Suggestions */}
      <div className="bg-accent/5 p-6 mb-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
       ...
       <Link
        href="/contact"
        className="flex-1 border-2 border-primary text-primary text-center py-4 font-semibold hover:bg-primary hover:text-white transition-all"
       >
        Contact & Devis
       </Link>
      </div>
