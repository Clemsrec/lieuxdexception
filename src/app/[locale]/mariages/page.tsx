  ...
  <main className="min-h-screen bg-stone-200">
   ...
   <HeroSection
    ...
    buttons={pageContent?.hero?.buttons || [
     { label: t('requestInfo'), href: `/${locale}/contact?form=mariage`, primary: true }
    ]}
   />
     ...
     <div className="container">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
       {pageContent.featureCards.filter((c: any) => c.visible !== false).sort((a: any, b: any) => (a.order || 0) - (b.order || 0)).map((card: any, index: number) => (
        <div key={index} className="bg-charcoal-800 p-6 md:p-8 border border-accent/20 shadow-lg">
   ...
   {(!pageContent?.featureCards || pageContent.featureCards.filter((c: any) => c.visible !== false).length === 0) && (
    <section className="section bg-stone">
     <div className="container">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
      {/* Card 01 */}
      <div className="bg-charcoal-800 p-6 md:p-8 border border-accent/20 shadow-lg">
       <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
